export const tr = {
  ...
  hero: {
    kicker: '1985\'ten bugüne güvenilir uygulama',
    title1: 'Hafriyat ve altyapı',
    title2: 'işlerinde güvenilir',
    titleEm: 'çözüm ortağınız',
    desc: 'Vargeloğlu İnşaat olarak altyapı, hafriyat ve çevre düzenleme işlerinde planlı, temiz ve zamanında teslim odaklı çalışıyoruz.',
